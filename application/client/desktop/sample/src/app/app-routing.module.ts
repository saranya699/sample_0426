...
{ path : 'sampleweconnecttemplates', loadChildren: () => import('./sampleweconnecttemplates/sampleweconnecttemplates.module').then(m => m.SampleweconnecttemplatesModule), canActivate: [AuthGuard] } , 
];
